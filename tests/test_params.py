...
class TestParamsIntegration():
    ...
    def test_params_integration(self, table, mock_records, mock_response_iterator):
        ...
        with Mocker() as m:
            mock_url = '{}?maxRecords=1&sort%5B0%5D%5Bdirection%5D=asc&sort%5B0%5D%5Bfield%5D=Name&view=View'\
                .format(table.url_table)
...
@pytest.mark.parametrize("kwargs,url_params", [
        [
            {'view': 'SomeView'},
            "?view=SomeView",
        ],
