...
SCAN_MODELS = {
    ...
    "pyairtable.models.comment:Attachment": "list-comments.response/@comments/items/@attachments/items",
    "pyairtable.models.comment:Attachment.Thumbnails": "list-comments.response/@comments/items/@attachments/items/@thumbnails",
    "pyairtable.models.comment:Attachment.Thumbnails.Thumbnail": "list-comments.response/@comments/items/@attachments/items/@thumbnails/@full",
